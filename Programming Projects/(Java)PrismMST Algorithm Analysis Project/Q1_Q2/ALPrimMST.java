...
public class ALPrimMST {
    ...
    public static void main(String[] args) {
        ...
        int V = rand.nextInt(100000)+1;
		ALPrimMST MST = new ALPrimMST();
		...
		for(int i=0; i<V-1; i++){
            for(int j=0; j<3; j++){
                ...
                int desti = rand.nextInt(V);
                
                int weight = rand.nextInt(15);
                
                System.out.println(i + " " + desti + " " + weight);
                MST.addEdge(graph, i, desti, weight);
            }
		}
		*/
		...
		//second demo
		ALPrimMST MST2 = new ALPrimMST();
        Graph graph2 = MST2.createGraph(V);
        MST2.addEdge(graph2, 0, 1, 4);
        MST2.addEdge(graph2, 0, 6, 8);
        MST2.addEdge(graph2, 1, 2, 7);
        MST2.addEdge(graph2, 1, 6, 11);
        MST2.addEdge(graph2, 2, 3, 7);
        MST2.addEdge(graph2, 2, 4, 4);
		MST2.addEdge(graph2, 2, 7, 2);
        MST2.addEdge(graph2, 3, 4, 14);
        MST2.addEdge(graph2, 4, 5, 2);
        MST2.addEdge(graph2, 5, 6, 1);
        MST2.addEdge(graph2, 5, 7, 6);
		MST2.addEdge(graph2, 6, 7, 7);
		


        // print the adjacency list representation of the above graph
        MST2.printGraph(graph2);
        System.out.println();
        MST2.getPrimsMST(graph2);
